-- Migration 006: Add p_skip_log parameter to validate_token
-- Prevents silent revalidations from flooding token_attempts table
-- Only actual logins and security events (blocked, version_upgrade) are logged
