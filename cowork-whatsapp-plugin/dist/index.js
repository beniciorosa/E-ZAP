...
function ensureReady() {
    if (!clientReady) {
        throw new Error(`WhatsApp not connected. Status: ${clientStatus}. ` +
            (qrCodeData
...
server.tool("whatsapp_reconnect", "Reconnect WhatsApp client (use if status is error or disconnected)", {}, async () => {
    if (clientReady) {
        return {
